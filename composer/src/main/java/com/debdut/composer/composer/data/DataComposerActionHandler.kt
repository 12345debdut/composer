 ...
 */
public interface DataComposerActionHandler {
     ...
     */
    public suspend fun receiveAction(dataComposerActionHolder: DataComposerActionHolder)
     ...
     */
    public fun receiveAllActions(action: Action)
}