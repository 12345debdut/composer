 ...
 */
public abstract class ListUIComposerWithHeaderAndFooterFragment<UISTATE: UIState, INITDATA: StoreInitObj, STOREMODEL: StoreInitObj>(
    ...
    public abstract override val container: ListWithHeaderAndFooterDataComposerHost<UISTATE, INITDATA, STOREMODEL>
