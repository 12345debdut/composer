package com.angelbroking.spark.libraries.composer.composer.ui.syntax

import androidx.lifecycle.Lifecycle
import androidx.lifecycle.LifecycleOwner
import androidx.lifecycle.lifecycleScope
import androidx.lifecycle.repeatOnLifecycle
import com.angelbroking.spark.libraries.composer.composer.data.syntax.footerState
import com.angelbroking.spark.libraries.composer.composer.data.syntax.headerState
 ...
 */
fun <UISTATE: UIState, INITDATA: StoreInitObj,STOREMODEL: StoreInitObj> ListUIComposerWithHeaderAndFooter<UISTATE, INITDATA,STOREMODEL>.observeHeaderState(
 ...
 */
fun <UISTATE: UIState, INITDATA: StoreInitObj, STOREMODEL: StoreInitObj> ListUIComposerWithHeaderAndFooter<UISTATE, INITDATA,STOREMODEL>.observeFooterState(
    lifecycleOwner: LifecycleOwner,
    lifecycleState: Lifecycle.State = Lifecycle.State.STARTED,
    observer: List<UISTATE>.() -> Unit
) {
