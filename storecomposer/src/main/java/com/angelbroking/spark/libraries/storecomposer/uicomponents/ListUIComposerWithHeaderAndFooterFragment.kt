package com.angelbroking.spark.libraries.storecomposer.uicomponents
...
import com.angelbroking.spark.libraries.storecomposer.composer.ui.ListUIComposerWithHeaderAndFooter
import com.angelbroking.spark.libraries.storecomposer.composer.ui.syntax.observeFooterState
import com.angelbroking.spark.libraries.storecomposer.composer.ui.syntax.observeHeaderState
 ...
 */
abstract class ListUIComposerWithHeaderAndFooterFragment<UISTATE: UIState, INITDATA: StoreInitObj, STOREMODEL: StoreInitObj>(
    @LayoutRes private val layoutId: Int
): ListUIComposerFragment<UISTATE, INITDATA, STOREMODEL>(layoutId = layoutId), ListUIComposerWithHeaderAndFooter<UISTATE, INITDATA, STOREMODEL> {

    abstract override val container: ListWithHeaderAndFooterDataComposerHost<UISTATE, INITDATA, STOREMODEL>
