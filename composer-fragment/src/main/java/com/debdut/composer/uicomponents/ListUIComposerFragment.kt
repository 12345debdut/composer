 ...
 *
 *     override val container: ListDataComposerHost<OrderState, OrderInitModel>
 *         get() = viewModel
 *
 ...
 */
public abstract class ListUIComposerFragment<UISTATE: UIState, INITDATA: StoreInitObj>(
    @LayoutRes private val layoutId: Int
): Fragment(layoutId), ListUIComposer<UISTATE, INITDATA> {
